...
public class KodalSamlRememberMeServices  extends TokenBasedRememberMeServices {
    ...
    public KodalSamlRememberMeServices(final String key, final UserDetailsService userDetailsService) {
