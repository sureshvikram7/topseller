...
public class DefaultTopsellableproductService implements TopsellableproductService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTopsellableproductService.class);
	...
	{
		return DefaultTopsellableproductService.class.getResourceAsStream("/topsellableproduct/sap-hybris-platform.png");
	}
